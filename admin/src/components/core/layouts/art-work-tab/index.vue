...
<template>
  <div
    v-if="showWorkTab"
    class="worktab-bar box-border flex-b w-full px-5 mb-3 select-none max-sm:px-[15px]"
    :class="[
  ...
  >
    <div class="worktab-viewport w-full overflow-hidden" ref="scrollRef">
      <ul
    ...
    <div class="worktab-actions flex">
      <div
