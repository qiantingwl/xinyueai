...
const zhCN = {
  ...
  settings: { general: '常规', personalization: '个性化', notifications: '通知', data: '数据控制', sidebar: '侧边栏', api: 'API 与模型', credits: '创作点', redeem: '兑换码', invite: '邀请与奖励', account: '账户', appearance: '外观', language: '语言', dark: '深色', light: '浅色', system: '跟随系统' },
...
const en = {
  workspace: { newChat: 'New chat', creation: 'AI creation', images: 'Images', videos: 'Videos', commerce: 'Commerce studio', office: 'Office center', prompts: 'Prompt library', plugins: 'Capabilities', projects: 'Projects', assets: 'Library', api: 'API', recent: 'Recent', noChats: 'No conversations', settings: 'Settings', signIn: 'Sign in', personalization: 'Personalization', account: 'Profile', logout: 'Sign out' },
  settings: { general: 'General', personalization: 'Personalization', notifications: 'Notifications', data: 'Data controls', sidebar: 'Sidebar', api: 'API & models', credits: 'Credits', redeem: 'Redeem code', invite: 'Invites & rewards', account: 'Account', appearance: 'Appearance', language: 'Language', dark: 'Dark', light: 'Light', system: 'System' },
...
const zhTW = {
  workspace: { ...zhCN.workspace, newChat: '新對話', creation: 'AI 創作', images: '圖片生成', videos: '影片生成', commerce: '電商中心', office: '辦公中心', prompts: '提示詞庫', plugins: '能力中心', projects: '專案', assets: '檔案庫', recent: '最近', noChats: '暫無對話', settings: '設定', signIn: '登入', personalization: '個人化', account: '個人資料', logout: '登出' },
  settings: { ...zhCN.settings, general: '一般', personalization: '個人化', notifications: '通知', data: '資料控制', sidebar: '側邊欄', api: 'API 與模型', credits: '創作點', redeem: '兌換碼', invite: '邀請與獎勵', account: '帳戶', appearance: '外觀', language: '語言', dark: '深色', light: '淺色', system: '跟隨系統' },
...
const ja = {
  workspace: { newChat: '新しいチャット', creation: 'AI 作成', images: '画像生成', videos: '動画生成', commerce: 'コマース', office: 'オフィス', prompts: 'プロンプト', plugins: '機能センター', projects: 'プロジェクト', assets: 'ライブラリ', api: 'API', recent: '最近', noChats: '会話はありません', settings: '設定', signIn: 'ログイン', personalization: 'パーソナライズ', account: 'プロフィール', logout: 'ログアウト' },
  settings: { general: '一般', personalization: 'パーソナライズ', notifications: '通知', data: 'データ管理', sidebar: 'サイドバー', api: 'API とモデル', credits: 'クレジット', redeem: 'コード交換', invite: '招待と報酬', account: 'アカウント', appearance: '外観', language: '言語', dark: 'ダーク', light: 'ライト', system: 'システム' },
...
const ko = {
  workspace: { newChat: '새 대화', creation: 'AI 만들기', images: '이미지 생성', videos: '동영상 생성', commerce: '커머스', office: '오피스 센터', prompts: '프롬프트', plugins: '기능 센터', projects: '프로젝트', assets: '라이브러리', api: 'API', recent: '최근', noChats: '대화 없음', settings: '설정', signIn: '로그인', personalization: '개인화', account: '프로필', logout: '로그아웃' },
  settings: { general: '일반', personalization: '개인화', notifications: '알림', data: '데이터 관리', sidebar: '사이드바', api: 'API 및 모델', credits: '크레딧', redeem: '코드 등록', invite: '초대 및 보상', account: '계정', appearance: '화면 모드', language: '언어', dark: '다크', light: '라이트', system: '시스템' },
