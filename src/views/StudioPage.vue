...
import { catalogModelKey, catalogModelLabel, catalogModelUnavailableMessage, findCatalogModel, isAgentModelEligible, isCatalogModelAvailable, type CatalogModel, type ModelCapability } from '../utils/model-catalog'
...
const capabilityModelAvailable = computed(() => isCatalogModelAvailable(findCatalogModel(capabilityModels.value, activeCapabilityModel.value, activeCapability.value === 'AGENT' ? 'CHAT' : activeCapability.value as ModelCapability)))
const activeCapabilityModelUnavailableMessage = computed(() => catalogModelUnavailableMessage(findCatalogModel(capabilityModels.value, activeCapabilityModel.value, activeCapability.value === 'AGENT' ? 'CHAT' : activeCapability.value as ModelCapability)))
const chatModelAvailable = computed(() => isCatalogModelAvailable(findCatalogModel(chatModels.value, model.value, 'CHAT')))
